...
export default function Page() {
  ...
  const contactRef = useOnInView(
      (inView) => {
        if (inView) setPageAndBackground('contact')
      }, options
  )
  return (
      <div className={`relative min-h-screen w-full transition-colors duration-1000 ease-in-out bg-linear-to-br ${bg}`}>
